...
-- 插入常用标签
INSERT IGNORE INTO tags (name, slug, description, color, usage_count, is_active) VALUES
('Java', 'java', 'Java编程语言', '#f89820', 0, true),
('Spring Boot', 'spring-boot', 'Spring Boot框架', '#6db33f', 0, true),
('Spring', 'spring', 'Spring框架', '#6db33f', 0, true),
('MySQL', 'mysql', 'MySQL数据库', '#4479a1', 0, true),
('Vue.js', 'vuejs', 'Vue.js前端框架', '#4fc08d', 0, true),
('JavaScript', 'javascript', 'JavaScript编程语言', '#f7df1e', 0, true),
('HTML', 'html', 'HTML标记语言', '#e34f26', 0, true),
('CSS', 'css', 'CSS样式表', '#1572b6', 0, true),
('React', 'react', 'React前端框架', '#61dafb', 0, true),
('Node.js', 'nodejs', 'Node.js运行环境', '#339933', 0, true),
('Python', 'python', 'Python编程语言', '#3776ab', 0, true),
('Docker', 'docker', 'Docker容器技术', '#2496ed', 0, true),
('Kubernetes', 'kubernetes', 'Kubernetes容器编排', '#326ce5', 0, true),
('Redis', 'redis', 'Redis缓存数据库', '#dc382d', 0, true),
('MongoDB', 'mongodb', 'MongoDB文档数据库', '#47a248', 0, true),
('Git', 'git', 'Git版本控制', '#f05032', 0, true),
('Linux', 'linux', 'Linux操作系统', '#fcc624', 0, true),
('算法', 'algorithm', '算法和数据结构', '#ff6b6b', 0, true),
('设计模式', 'design-pattern', '软件设计模式', '#4ecdc4', 0, true),
('微服务', 'microservice', '微服务架构', '#45b7d1', 0, true),
('性能优化', 'performance', '性能优化技术', '#96ceb4', 0, true),
('安全', 'security', '信息安全技术', '#ffeaa7', 0, true),
('测试', 'testing', '软件测试技术', '#fd79a8', 0, true),
('CI/CD', 'cicd', '持续集成和部署', '#a29bfe', 0, true),
('API', 'api', 'API设计和开发', '#6c5ce7', 0, true),
('数据结构', 'data-structure', '数据结构', '#fd79a8', 0, true),
('网络编程', 'network', '网络编程技术', '#00b894', 0, true),
('并发编程', 'concurrent', '并发和多线程编程', '#e17055', 0, true),
('函数式编程', 'functional', '函数式编程', '#0984e3', 0, true),
('机器学习', 'machine-learning', '机器学习和AI', '#00cec9', 0, true);
...
'学习 Spring Boot 框架的完整指南，包括自动配置、起步依赖、内嵌服务器等核心特性', '2024-12-01 10:00:00'),
...
'MySQL 数据库性能优化的完整指南，涵盖索引设计、查询优化、配置调优等方面', '2024-12-02 14:30:00'),
...
'Vue.js 3.0 新特性完整指南，包括 Composition API、性能优化、TypeScript 支持等', '2024-12-03 09:15:00'),
...
'Docker 容器化部署的完整实践指南，涵盖镜像构建、服务编排、最佳实践等', '2024-12-04 16:45:00'),
...
'算法与数据结构学习笔记，涵盖常见算法实现和数据结构应用', '2024-12-05 11:20:00');
